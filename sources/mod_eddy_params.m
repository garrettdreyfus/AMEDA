function [b,bi,bx,bxi,f,f_i,Dx,Dxi] =  mod_eddy_params(keys_sources,stepF)
...
%----------------------------------------------
save([path_out,'param_eddy_tracking'],'-v7.3', ...
    ...
    'deg','resol','level','Rd','Rd_typ','K','Dx','Dxi',...
    'stepF','T','g','dps','V_eddy','Dt','cut_off','D_stp','N_can','DH','nH_lim','n_min','lat_min',...
